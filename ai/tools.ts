...
export const mermaidTool = tool({
  description: "Generate mermaid diagrams based on user description. Creates flowcharts, sequence diagrams, class diagrams, state diagrams, and more.",
  inputSchema: z.object({
    description: z.string().describe("The description of what diagram to create"),
  }),
  execute: async ({ description }) => {
    // This tool is AI-driven - the AI model will generate the mermaid code
    // The description is passed to the AI, which returns mermaid syntax
    // For now, we return a structure that indicates the AI should generate the code
    return {
      description,
      // The actual mermaid code will be generated by the AI model in the response
      mermaidCode: "", // Placeholder - AI will fill this in its response
    };
  },
});
...
export const tools = {
  ...
  generateMermaidDiagram: mermaidTool,
};
