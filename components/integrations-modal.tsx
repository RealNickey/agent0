...
import { CloudSun, Plus, Trash2, ExternalLink, Calendar, FileText, Mail, ListTodo, Network, FileStack, ImageIcon } from "lucide-react";
...
const INTEGRATIONS = [
  ...
  },
  {
    id: "image",
    name: "Image",
    description: "Generate images from text prompts using Stable Diffusion AI.",
    icon: ImageIcon,
    color: "text-pink-500",
