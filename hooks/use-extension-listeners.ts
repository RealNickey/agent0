...
export function useExtensionListeners(
  ...
  useEffect(() => {
    ...
    const handleAuthMessage = (event: MessageEvent) => {
      ...
      if (event.data?.type === 'GOOGLE_SHEETS_AUTH_SUCCESS') {
        console.log('Google Sheets Auth success received');
  ...
  }, [setAttachments, setInputValue, setIsCalendarConnected, setIsFormsConnected, setIsTasksConnected, setIsSheetsConnected, setEnableSearch]);
}
