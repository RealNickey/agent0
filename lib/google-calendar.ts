...
// Google Slides API scopes (Drive upload & conversion)
export const GOOGLE_SLIDES_SCOPES = ["https://www.googleapis.com/auth/drive.file"];

// Combined scopes for Calendar, Forms, and Slides
 ...
 * @param service - Which service to authorize: 'calendar', 'forms', 'slides', or 'all'
 */
export function getAuthorizationUrl(
  state?: string,
  service: "calendar" | "forms" | "tasks" | "slides" | "all" = "calendar"
): string {
  let scopes: string[];
  switch (service) {
    case 'forms':
